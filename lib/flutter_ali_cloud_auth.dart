...
class FlutterAliCloudAuth {
  ...
  static const MethodChannel _channel =
      const MethodChannel('flutter_ali_cloud_auth');
  static int idPool = 1;
  static Map<int, Function> callbacks = {};
  static Future<bool> init() async {
    print("init flutter MethodChannel name: flutter_ali_cloud_auth ");
  ...
  //token passby config['token']
  //native passby config['native']
  //config['skinInAssets']
  //config['skinPath']
